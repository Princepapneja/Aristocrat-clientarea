...
const SucessLogReg = ({ data, resend, showBtn, type }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
      <div className=" text-black rounded-[20px] shadow-md p-10 max-w-md w-full text-center" style={{
        ...
        {
          type === "loginBtn" ?
           (showBtn ? <button onClick={(()=>{navigate("/")})} className={"rounded-[10px] py-2.5 px-8 w-80 mt-5 text-black border border-black bg-[rgba(255,255,255,0.3)] hover:bg-[rgba(255,255,255,0.5)]"}>Go to Login Page</button> : "")
